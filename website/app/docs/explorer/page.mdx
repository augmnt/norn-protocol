...
| `/address/[address]` | Account balances, transaction history, primary NNS name and records |
...
Address pages display the primary NNS name and any attached name records. Block detail pages show name transfers and name record updates alongside other block activity.
